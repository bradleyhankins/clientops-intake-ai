...
For client diagnostic workflows, preserve the maturity score, primary bottleneck, recommended toolkit app, automation opportunities, and roadmap generated by the rules-based workflow.
